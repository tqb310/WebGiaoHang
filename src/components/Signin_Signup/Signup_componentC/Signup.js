                ...
                <FormWrap>
                    ...
                    <FormContent>
                        ...
                        <Icon to='/'>delivery</Icon>
                            ...
                            <FormInput type='email' onChange={setEmails} required />
                            <FormLabel htmlFor='for' >Mật khẩu</FormLabel>
                            <FormInput type='password' onChange={setPassW} required />
                            <FormLabel htmlFor='for'>Xác nhận mật khẩu</FormLabel>
                            <FormInput type='password' onChange={confirmPassword}  required />
                            <FormButton type='button' onClick={_signup}>Tiếp tục</FormButton>
